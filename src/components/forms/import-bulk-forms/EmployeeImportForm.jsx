...
function EmployeeImportForm({ closeModal = null }) {
  ...
  const { mutate } = useMutate([queryKeys.CreateEmployee]);
  ...
  const handleSubmit = async (event) => {
    ...
    mutate(
      {
        url: `/employee/bulk/add/employees`,
        data: formData,
        method: "POST",
        multipart: true,
      },
      {
        async onSuccess(data) {
          await queryClient.invalidateQueries([queryKeys.Employees]);
  ...
  const handleLabelClick = (event) => {
    // Prevent parent click event from being triggered
      ...
      <div>
        ...
        <div className="my-8">
          ...
          <div className="flex justify-center items-center gap-5 mb-3">
            <a
              href="/images/AllEmployeesWithData.xlsx"
              download="AllEmployeesWithData.xlsx"
            >
            ...
            <a
              href="/images/AllEmployeesWithoutData.xlsx"
              download="AllEmployeesWithoutData.xlsx"
            >
        ...
        <form onSubmit={handleSubmit}>
          <label
            className="mb-3 block text-blue-900 text-md font-semibold leading-loose"
          ...
          {fileName && (
            <div className="mt-2 text-center text-sm font-semibold text-blue-900">
