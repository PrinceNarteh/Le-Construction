...
function ClientImportForm({ closeModal = null }) {
  ...
  const { mutate } = useMutate([queryKeys.CreateClient]);
    ...
    mutate(
      ...
      },
      {
        async onSuccess(data) {
          ...
          if (closeModal) closeModal();  // Close modal after success
        },
        onError(error) {
      ...
      <div>
        ...
        <div className="my-8">
          ...
          <div className="flex justify-center items-center gap-5  mb-3">
            <a
              href="/images/AllClientsWithData.xlsx"
              download="AllClientsWithData.xlsx"
            >
            ...
            <a
              href="/images/AllClientsWithoutData.xlsx"
              download="AllClientsWithoutData.xlsx"
            >
